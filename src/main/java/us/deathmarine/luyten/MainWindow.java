...
public class MainWindow extends JFrame {
    ...
    public MainWindow(File fileFromCommandLine) {
        ...
        setTheme(configSaver.getLuytenPreferences().getThemeXml());
    ...
    private String getLegalStr() {
        ...
        try {
            BufferedReader reader = new BufferedReader(
                    new InputStreamReader(getClass().getResourceAsStream("/Procyon.License.txt")));
            String line;
            ...
            reader = new BufferedReader(
                    new InputStreamReader(getClass().getResourceAsStream("/RSyntaxTextArea.License.txt")));
            while ((line = reader.readLine()) != null) {
                sb.append(line).append("\n");
            }
        } catch (IOException e) {
    ...
    public void onThemesChanged() {
        ...
        String theme = luytenPrefs.getThemeXml();
    ...
    private void setTheme(String theme) {
        ...
        } else if (theme.contains("default")) {
            FlatLightLaf.install();
            try {
        ...
        } else if (theme.contains("eclipse")) {
            FlatLightLaf.install();
            try {
                UIManager.setLookAndFeel(new FlatLightLaf());
            } catch (Exception ex) {
